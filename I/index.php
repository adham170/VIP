...
User-Agent: Instagram 177.0.0.30.119 Android (29/10; 280dpi; 720x1422; samsung; SM-A207F; a20s; qcom; en-US)
...
'referer: https://login.live.com/login.srf?wa=wsignin1.0&rpsnv=13&ct=1603551755&rver=7.0.6737.0&wp=MBI_SSL&wreply=https%3a%2f%2foutlook.live.com%2fowa%2f%3fnlp%3d1%26RpsCsrfState%3d7dbd6a50-ceb8-5560-7ad7-d2967f234756&id=292841&aadredir=1&CBCXT=out&lw=1&fl=dob%2cflname%2cwld&pcexp=false&cobrandid=90015',
'sec-fetch-mode: cors',
'sec-fetch-site: same-origin',
'user-agent: Mozilla/5.0 (Linux; Android 10; ART-L29) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.4324.93 Mobile Safari/537.36'
    ]);
  curl_setopt($ch, CURLOPT_FOLLOWLOCATION, 1);
  curl_setopt($ch, CURLOPT_ENCODING , "");
  curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
  curl_setopt($ch,CURLOPT_POST, 1);
  curl_setopt($ch,CURLOPT_POSTFIELDS, '{"username":"'.$mail.'","uaid":"'.$uaid.'",""","isOtherIdpSupported":false,"checkPhones":false,"isRemoteNGCSupported":true,"isCookieBannerShown":false,"isFidoSupported":false,"forceotclogin":false,"otclogindisallowed":false,"isExternalFederationDisallowed":false,"isRemoteConnectSupported":false,"federationFlags":3,"isSignup":false,"flowToken":"DcQY6o26zmoEHXj9cLAteISjHwTkn2gd8GJgNvlhMpZAF4H1kxUameLWO4N!1zZBnZKVHpy0is15c11eYmxioKNUtmj1yWC5Ut88rL6dDklzoOPnDAmOfBI8wksJtUWVs0!bAckshvziXeSiMftqtOoLTnQFIBrgHMNwQaewpbxD5uD!MRQXYV3elyDyro6W4gWzQ14esFyXWcLKykE2Gs7qnDsYcCR1RpBkVR*O5PQ2Q6hk9BAdT1rBFj13eZT0tg$$"}');
  $res = curl_exec($ch);
  curl_close($ch);
...
class ig {
	...
	public function __construct($settings){
		...
		$this->account['useragent'] = 'Instagram 27.0.0.7.97 Android (28\/9; 320dpi; 720x1544; OPPO; CPH2015; OP4C7D; mt6765; en_US)';
	...
	private function request($path,$account = 0,$post = 0,$datas = 0,$returnHeaders = 0){
	  ...
	  if($account == 0){
	  	curl_setopt($ch, CURLOPT_HTTPHEADER, array(
		     ...
		     'user-agent: Instagram 27.0.0.7.97 Android (28\/9; 320dpi; 720x1544; OPPO; CPH2015; OP4C7D; mt6765; en_US)',
		     'host: i.instagram.com',
		     'X-CSRFToken: missing',
		     'X-Instagram-AJAX: 1',
