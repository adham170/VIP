			...
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/X_Q_9",
                   'caption'=>'𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐇𝐄𝐋𝐋 𝐀𝐋𝐌𝐒𝐓𝐄𝐑 𝐀𝐍𝐃 𝐀𝐇𝐌𝐄𝐃 𝐇𝐔𝐍𝐓𝐄𝐑 ،🥀 - BY- @X_Q_9 ✹ @l_w_7',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'• إضافة حساب وهمي جديد 🎶','callback_data'=>'login']],
                          [['text'=>"قناء البوت 🕵️", 'url'=>"t.me/x_q_9"]],
                      ]
                  ])
              ]);   
          	...
          	if($config['mode'] != null){
          		...
          		if($mode == 'addL'){
          		  ...
          		  if(is_numeric($text)){
                      ...
                      'chat_id'=>$chatId,
                      'message_id'=>$mid,
                      'text'=>"• اهلن بك في اداءاحمد هنتر و الماستر🕺لصيد متاحات انستقرام بكل السهوله✌️
مـطور ~» @X_Q_9 🔪
المطور² ~» @l_w_7",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
...
لشراء نسخه مراسلة المطور 👁‍🗨',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'▫️| مطور البوت','url'=>'t.me/X_Q_9']],
                       [['text'=>"مطور البوت²", 'url'=>"t.me/l_w_7"]],
                      ]
                  ])
              ]);   
				}
